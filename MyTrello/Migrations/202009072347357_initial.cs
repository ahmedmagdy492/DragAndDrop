namespace MyTrello.Migrations
{
    ...
    public partial class initial : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Jobs", "RoomId", "dbo.Rooms");
            DropForeignKey("dbo.AspNetUsers", "Room_Id", "dbo.Rooms");
            DropForeignKey("dbo.Rooms", "CreatorId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Rooms", new[] { "CreatorId" });
            DropIndex("dbo.Jobs", new[] { "RoomId" });
